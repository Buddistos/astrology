<?php
/*
    echo "Извините, на сайте проводятся технические работы. Просмотр астропрогнозов для зарегистрированных пользователей проходит в обычном режиме по ссылкам, приходящим в почту.";
    exit;
*/
...
<body>
    ...
    <div class="container">
        ...
        <div class="block">
            <h2><b class="attention" style="font-size: 32px;">Волшебство начинается</b> уже сейчас - дарим гороскопы! Навсегда! Без SMS и без оплаты!</h2>
            <img src="images/magicbook.gif" align="left" width="350">
            <div style="padding-left: 365px;">
                <p>
                    Закажите гороскоп по одному из направлений и получите еще <b class="attention">ПЯТЬ ГОРОСКОПОВ</b> в подарок!
                </p><p>
                    Например, вы заказываете <b>любовный гороскоп</b> и также получаете <b>гороскоп здоровья</b>, <b>авто-гороскоп</b>, <b>финансовый гороскоп</b>, <b>отпускной гороскоп</b> и <b>бизнес-гороскоп</b> в подарок!
                </p>
                <h3 class="attention">БЕСПЛАТНО ВСЕ!</h3>
                <p>
                    Уже оставили заявку на гороскопы <b><?php echo $orders; ?></b> раз!<br>
                    Успевайте! Время действия подарка ограничено!
                </p>
            </div>
        ...
        <div class="block" style="padding-bottom: 50px;">
            <h2 style="color: darkred;">ПОЛУЧИТЬ ЕЖЕДНЕВНЫЕ ГОРОСКОПЫ БЕСПЛАТНО<br>
            ПО ШЕСТИ НАПРАВЛЕНИЯМ ВМЕСТО ОДНОГО!</h2>
            <p class="aligncenter">
                <br>
                <a href="javascript:void(0);" class="button show_modal" onclick="yaCounter25119665.reachGoal('button_2'); return true;"><b>Я ХОЧУ ПОЛУЧИТЬ ГОРОСКОПЫ НА ВСЕ СЛУЧАИ ЖИЗНИ БЕСПЛАТНО</b></a>
            </p>
        </div>
        ...
        <div class="feature">
            ...
            <div class="carusel">
                <ul>
                    <li><a href="images/feature/goro1.png" class="fancybox" rel="group"><img src="images/feature/goro1mini.png"></a></li>
                    <li><a href="images/feature/goro4.png" class="fancybox" rel="group"><img src="images/feature/goro4mini.png"></a></li>
                    <li><a href="images/feature/goro3.png" class="fancybox" rel="group"><img src="images/feature/goro3mini.png"></a></li>
                    <li><a href="images/feature/goro2.png" class="fancybox" rel="group"><img src="images/feature/goro2mini.png"></a></li>
                </ul>
            </div>    
        </div>
        ...
        <div class="block reviews">
            ...
            <div class="alignright">
                ...
                <p style="padding-left: 220px;">
                    ...
                    <br><br>
                    <a href="/show/?gsk=223882ad2d4f8b94fd64c9da83fe50f4&uid=447&udt=20080317" target="_blank">Смотреть астропрогноз для Людмилы на этот день</a>
                </p>
                <p>
            ...
            <div class="alignright">
                ...
                <p style="padding-left: 220px;">
                    ...
                    <br><br>
                    <a href="/show/?gsk=8a0541d5bc415baf32d7facd7e0e85ee&uid=1286&udt=20080524" target="_blank">Смотреть астропрогноз для Григория на этот день</a>
                </p>
                <p>
                    <b>Комментарий астролога</b><br>
            ...
            <div class="alignright">
                ...
                <p style="padding-left: 220px;">
                    ...
                    <br><br>
                    <a href="/show/?gsk=6e237741fee308567ae925dc33619136&uid=1487&udt=20080510" target="_blank">Смотреть астропрогноз для Анны на этот день</a>
                </p>
                <p>
                    <b>Комментарий астролога</b><br>
            ...
            <div class="alignright">
                ...
                <p style="padding-left: 220px;">
                    ...
                    <i>В этом месяце мне была назначена хирургическая операция. Операция была плановая, все консультации с врачами были позади, платная палата была подготовлена. Но мне было все равно не по себе, так как операцию тяжело назвать приятным событием, тем более наслушавшись от своих знакомых всяких страшилок, о том что может случится или же пойти не так.<br>
                    ...
                    <br><br>
                    <a href="/show/?gsk=b5987bd587a4d06a7225bb17601e721b&uid=2523&udt=20080518" target="_blank">Смотреть астропрогноз для Геннадия на этот день</a>
                </p>
                <p>
                    <b>Комментарий астролога</b><br>
        ...
        г. Екатеринбург, Интернет-группа "Астроном и я", "Андрей Перье", ИП, ОГРНИП 310667016100048, +7 932-123-97-51, email: <a href="mailto:andreyperje@best-horoscope.ru" style="font-size: 12px; text-decoration: none; color: #777;">andreyperje@best-horoscope.ru</a>
    ...
    <div class="popup_modal" id="_love_modal">
        ...
        <p>Персональный любовный гороскоп покажет Вам благоприятные и "нехорошие" периоды и описание возможных событий в сфере романтичных отношений, свиданий, объяснений, помолвки и брака. Подскажет дни, когда очень вероятны новые знакомства, дни для выяснения отношений, дни для удачного флирта, дни сексуальной активности.
        </p><p>
        Но, как и всегда в жизни, бывают неблагоприятные периоды, когда все идет не так. Точнее, пошло бы не так, если бы Вы не знали прогноза... И теперь мы предупредим Вас о предстоящих неприятностях, и в Ваших силах будет их избежать.
    ...
    <div class="popup_modal" id="_auto_modal">
        ...
        Как говорят, кто предупрежден, тот вооружен - и если Вы учтете эти предупреждения, не будете активничать в опасные дни - все пройдет, и наступит хороший период, а Вы избежите неприятностей.
        </p><p class="aligncenter" style="padding: 20px 0;">
    ...
    <div class="popup_modal" id="_health_modal">
        ...
        <p>Ваш персональный гороскоп здоровья предупредит Вас об опасных днях, когда Вы рискуете заболеть, получить травму, неудачно пройти обследование, стать жертвой ошибки стоматолога и т.д. Но Вы получите и данные о благоприятных периодах, когда удачны будут плановые операции, когда надо начинать курс назначенных процедур, когда лучше входить в диету, когда обследование даст надежные результаты и т.д.
        </p><p class="aligncenter" style="padding: 20px 0;">
    ...
    <div class="popup_modal" id="_business_modal">
        ...
        Если Вы будете просто "плыть по течению", инстинктивно, не вполне осознанно реагирую на изменяющиеся обстоятельства жизни и бизнеса, то и получите то, "что на роду написано". Но если Вы сможете учесть в своей деятельности подсказки и советы судьбы, то будете намного успешнее продвигаться в неспокойном море бизнеса.
        </p><p class="aligncenter" style="padding: 20px 0;">
...
<div class="pluso-engine" style="position: fixed;  top: 50px;" pluso-sharer={"buttons":"vkontakte,odnoklassniki,facebook,twitter,google,moimir,email,print,more","style":{"size":"big","shape":"round","theme":"theme05","css":"background:transparent"},"orientation":"vertical","multiline":false}  data-title="%D0%9C%D0%BE%D0%B9%20%D0%BB%D0%B8%D1%87%D0%BD%D1%8B%D0%B9%20%D0%B0%D1%81%D1%82%D1%80%D0%BE%D0%BF%D1%80%D0%BE%D0%B3%D0%BD%D0%BE%D0%B7"
     data-description="Пожалуй лучший индивидуальный астропрогноз, построенный по дате рождения. Без оплаты и без СМС. Навсегда." data-image="http%3A%2F%2Fbest-horoscope.ru%2Fimages%2Fnostradamus.png"></div> 
