             ...
             // Your code here 
                VK.api("getProfiles", {uids:window.viewer_id, fields:"bdate, sex, photo_medium"}, function(data) { 
                    ...
                    $(".share").html(VK.Share.button({
                        ...
                        image: "//best-horoscope.ru/apps/astronom.png",
                        noparse: true
                    },{
                        type: "round_nocount",
...
<body>
    <div class="container">
        ...
        <div class="block">
            ...
            <?php if(!$gsk || 1): ?>
                <div style="float: right; margin-top: 9px;">
                    ...
                    <div style="margin-top: 5px;">
                        <a href='/vkapps/'>Интерпретации аспектов</a>
                    </div>
                    <div style="margin-top: 5px;">
        ...
        <div id="payment" style="display: none;">
            ...
            <p>
                Для просмотра <a href="/vkapps/">интерпретаций аспектов</a> необходимы <b>Звезды</b>. Каждый день, когда вы заходите в приложение <b>Астрологический календарь</b> вам начисляются три звезды.<br>
