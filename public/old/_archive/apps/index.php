...
<body>
    <div class="container">
        ...
        <div class="block">
            <?php if(!$guest && $gsk): ?>
                <div id="goback"><a href="/apps/"><img src="/images/arrow-left.png" width="40"/></a></div>
            <?php endif; ?>
            ...
            <?php if(!$gsk): ?>
                <div style="float: right; margin-top: 9px;">
                    ...
                    <div style="margin-top: 5px;">
                        <a href='/vkapps/'>Аспекты планет</a>
                    </div>
                    <div style="margin-top: 5px;">
            ...
            <div id="goro" style="clear: both;">
                <?php if($gsk): ?>
                    <div class="mygoro shadowing" style="overflow: hidden; clear: both;margin-top: 10px; float:left; border-radius: 10px;">
        ...
        <a href="http://best-horoscope.ru" target="_blank" style="font-size: 12px; text-decoration: none; color: #777;">Интернет-группа "Астроном и я"</a>
        </p>
